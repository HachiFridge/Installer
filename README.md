# Fridgerator Installer

Simple installer for Fridgerator. Built against the latest DLLs from [HachiFridge/Fridgerator](https://github.com/HachiFridge/Fridgerator).
...
- Usage: `fridgerator_installer.exe [OPTIONS] <SUBCOMMAND>`
- Subcommands:
  - install
  - uninstall
- Options:
...
Put fridgerator.dll in the root directory, build as any other rust application.
